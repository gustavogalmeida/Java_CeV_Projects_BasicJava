 ...
 */
package swingaula_olamundo;

/**
 *
 * @author Gustavo Almeida
 */
public class SwingAula extends javax.swing.JFrame {

    /**
     * Creates new form SwingAula
     */
    public SwingAula() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnClique.setBackground(new java.awt.Color(51, 51, 255));
        btnClique.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnClique.setForeground(new java.awt.Color(255, 255, 255));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SwingAula.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
